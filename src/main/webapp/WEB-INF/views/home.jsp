...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            <label class="navbar-brand" style="color: white"><span class="glyphicon glyphicon-music" aria-hidden="true"></span></label>
        </div>
        <div>
            ...
            <form class="navbar-form navbar-right" role="search">
                ...
                <button type="submit" class="btn btn-success" style="height: 35px"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
            </form>
