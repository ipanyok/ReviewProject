        ...
        <div class="card-deck">
            ...
            <div class="card border-success">
                ...
                <div class="card border-danger">
                    ...
                    <img class="card-img-top" src="/getphoto/${review.getKey().idTitle}" alt="NO IMAGE" style="width: 332px; height: 10vw; ">
                    ...
                    <div class="card-body text-success" style="background-color: #3a3a3a">
                        ...
                        <div class="card-body text-danger" style="background-color: #3a3a3a;">
                            ...
                            <c:if test="${review.getKey().text.length() > 25}">
                                <p class="card-text" style="font-family: 'Segoe Print'">${review.getKey().text.substring(0, 25)}<a href="#" style="color: blue">...read more...</a></p>
                            </c:if>
                            <c:if test="${review.getKey().text.length() <= 25}">
